...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="display-5 mb-0">Gestión de Grupos</h1>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0">
                        ...
                        {{ isset($_GET['edit']) ? 'Editar Grupo' : 'Crear Nuevo Grupo' }}
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ isset($_GET['edit']) ? route('groups.update', $_GET['edit']) : route('groups.store') }}" 
                        ...
                        <div class="mb-3">
                            <label for="number_of_students" class="form-label">Número de Estudiantes</label>
                            <input type="number" 
                                   class="form-control" 
