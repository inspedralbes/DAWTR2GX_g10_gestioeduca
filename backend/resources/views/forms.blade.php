        ...
        <table class="table-auto w-full border-collapse border border-gray-300">
            ...
            <tbody>
                <?php foreach ($forms as $form): ?>
                    <tr>
                        <td class="border border-gray-300 px-4 py-2"><?php echo $form->id; ?></td>
                        <td class="border border-gray-300 px-4 py-2"><?php echo $form->title; ?></td>
                        <td class="border border-gray-300 px-4 py-2">
                            <!-- Botón para Ver -->
                            <a href="<?php echo route('forms.show', $form->id); ?>" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Ver</a>

                            <!-- Botón para Editar -->
                            <a href="<?php echo route('forms.index', ['edit' => $form->id]); ?>" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Editar</a>

                            <!-- Formulario para Eliminar -->
                            <form action="<?php echo route('forms.destroy', $form->id); ?>" method="POST" class="inline">
